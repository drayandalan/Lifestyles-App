...
public class DefaultFootballAppConsumer<T> {
    ...
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, T>>
    registerKafkaListenerContainerFactory() {
